	...
	<body>
		...
		<div id="show-producto" class="content scaffold-show" role="main">
			...
			<ol class="property-list producto">
				...
				<g:if test="${productoInstance?.caracteristica}">
				<li class="fieldcontain">
					<span id="caracteristica-label" class="property-label"><g:message code="producto.caracteristica.label" default="Caracteristica" /></span>
					
						<span class="property-value" aria-labelledby="caracteristica-label"><g:fieldValue bean="${productoInstance}" field="caracteristica"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${productoInstance?.servicio}">
				<li class="fieldcontain">
					<span id="servicio-label" class="property-label"><g:message code="producto.servicio.label" default="Servicio" /></span>
					
						<span class="property-value" aria-labelledby="servicio-label"><g:link controller="servicio" action="show" id="${productoInstance?.servicio?.id}">${productoInstance?.servicio?.encodeAsHTML()}</g:link></span>
